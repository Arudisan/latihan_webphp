...
<head>
	...
	<link rel="stylesheet" href="assets2/bootstrap5/css/bootstrap.min.css" />
...
<body>
	...
	<header class="bg-white">
		<div class="container-fluid d-flex justify-content-center align-items-center p-3">
			...
			<span>
				<img src="assets2/images/header.png" class="rounded-circle img-fluid img-thumbnail" width="500" />
			</span>
		</div>
	</header>
		...
		<div class="container-fluid d-flex flex-column align-items-center p-4">
			...
			<div class="row">
				...
				<div class="col-md-5">
					...
					<div>
						<span class="badge bg-info text-white rounded-3 fs-6"> <?php echo $row['dateinput'];?></span>
		...
		<div class="container p-4">
			...
			<div class="row">
				...
				<div class="col col-lg-7">
					<form action="admin/mod_responden/respondenctrl.php?modul=mod_responden&act=save" method="post">
						<div class="row mb-3">
							<label for="staticEmail" class="col-md-3 form-label">Email</label>
							<div class="col-md-9">
							    <input type="hidden" class="form-control" name="no_responden" />
						...
						<div class="row mb-3">
							...
							<div class="col-md-9">
								<select id="info" class="form-select" name="infor">
				<?php
                   $qry_listinfo= mysqli_query($connect_db,"select * from tabel_kat_informasi")or die("gagal akses tabel_kat_informasi".mysqli_error($connect_db));
                 while($row = mysqli_fetch_array($qry_listinfo)){
                ?>
                <option value="<?php echo $row['id_info'];?>"><?php echo $row['kat_informasi'];?></option>
                <?php
                }
                ?>
				</select>
						...
						<div class="row mb-3">
							...
							<div class="col-md-9">
								<textarea name="keterangan" id="ket" cols="30" rows="5" class="form-control"></textarea>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-md-9 text-center">
								<button class="btn btn-primary btn-sm"><i class="bi bi-envelope"  type="submit"></i> Simpan</button>
								<button class="btn btn-secondary btn-sm"><i class="bi bi-reply"  type="reset"></i> Batal</button>
							</div>
						</div>
					</form>
				</div>
...
<?php echo $row['author'];?><?php echo $row['dateinput'];?>	
<?php echo $namafile;?> -->